...
For a fuller explanation of the project value, content framework, and recommended execution order, see [PROJECT_BRIEF.md](PROJECT_BRIEF.md). For Chinese readers, see [zh-CN/PROJECT_BRIEF.md](zh-CN/PROJECT_BRIEF.md). For a quickstart guide, see [docs/PLAYBOOK.md](docs/PLAYBOOK.md).
